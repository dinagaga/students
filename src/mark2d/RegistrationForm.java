...
public class RegistrationForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pw.setFont(new java.awt.Font("Times New Roman", 2, 12)); // NOI18N
    ...
    private void registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerActionPerformed
        ...
        if (dbc.insertData("INSERT INTO tbl_user (u_fname,u_lname,u_email,u_username,u_password,u_type,u_status)"
                + "VALUES('" + fn.getText() + "','" + ln.getText() + "','" + em.getText() + "','" + un.getText() + "','" + pw.getText() + "','" + ut.getSelectedItem() + "','Pending')")) {
